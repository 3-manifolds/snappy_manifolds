...
(name, cusps, perm, betti, torsion, volume, chernsimons, tets, hash, isosig)
values ('%s', %s, %s, %s, '%s', %s, %s, %s, '%s', '%s')"""

link_insert_query = """insert into %s
(name, cusps, perm, DT, betti, torsion, volume, chernsimons, tets, hash, isosig)
...
(name, cusps, perm, betti, torsion, volume, tets, hash, isosig)
